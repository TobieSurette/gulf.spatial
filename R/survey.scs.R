#' Snow Crab Survey Sampling Stations
#'
...
#'    included in the output. Alternatively, the output from a previous call of
#'    \code{select.sc.stations} may be used. Specifically, the grid definitions
#'    specified in the \code{grids} element of the output is used to generate
#'    points within each element. Alternately, if the complete of grids which
#'    overlay the sGSL survey area is dersired, set \code{grids = \sQuote{complete}} 
