...
#'
#' A dataset containing the polygons of fishing zones. This includes
#' the coastline from the Atlas of Canada.
#'
#' @format A simple feature data frame with 113 rows and 5 variables:
#' \describe{
